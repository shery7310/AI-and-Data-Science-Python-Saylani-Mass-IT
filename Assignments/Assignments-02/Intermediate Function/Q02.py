...
# For example, if nth = 3, the function will call rec_fibonacci(2) and rec_fibonacci(1). The result of rec_fibonacci(2) will be computed recursively, while rec_fibonacci(1) directly hits the base case and returns 1.
